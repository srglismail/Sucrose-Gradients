...
```
```{r}
df3WT <- read_delim("Data4/measurements_18-06-02_11-11-54 WT Keio 2hours after OD600 0_3.lvm", 
    delim = "\t", escape_double = FALSE, 
    locale = locale(decimal_mark = ",", grouping_mark = "."), 
    trim_ws = TRUE, skip = 21,
    col_select = c("Time", "Signal"))
...
```{r}
df3WTCAM <- read_delim("Data4/measurements_18-06-02_11-18-46 WT Keio CAM 2hours.lvm", 
    delim = "\t", escape_double = FALSE, 
    locale = locale(decimal_mark = ",", grouping_mark = "."), 
    trim_ws = TRUE, skip = 21,
    col_select = c("Time", "Signal"))
...
```
```{r}
df3yjeQ <- read_delim("Data4/measurements_18-06-02_11-37-30 yjeQ 2hour plus OD600 0_3.lvm", 
    delim = "\t", escape_double = FALSE, 
    locale = locale(decimal_mark = ",", grouping_mark = "."), 
    trim_ws = TRUE, skip = 21,
    col_select = c("Time", "Signal"))
...
```{r}
df3yjeQCAM <- read_delim("Data4/measurements_18-06-02_11-43-11 yjeQ CAM 2hour.lvm", 
    delim = "\t", escape_double = FALSE, 
    locale = locale(decimal_mark = ",", grouping_mark = "."), 
    trim_ws = TRUE, skip = 21,
    col_select = c("Time", "Signal"))
...
```{r}
df4WT <- read_delim("Data5/measurements_21-12-24_10-42-56.lvm", 
    delim = "\t", escape_double = FALSE, 
    locale = locale(decimal_mark = ",", grouping_mark = "."), 
    trim_ws = TRUE, skip = 21,
    col_select = c("Time", "Signal"))
...
df4WTCam <- read_delim("Data5/measurements_21-12-24_11-01-58.lvm", 
    delim = "\t", escape_double = FALSE, 
    locale = locale(decimal_mark = ",", grouping_mark = "."), 
    trim_ws = TRUE, skip = 21,
    col_select = c("Time", "Signal"))
...
df4yjeQ <- read_delim("Data5/measurements_21-12-24_10-48-46.lvm", 
    delim = "\t", escape_double = FALSE, 
    locale = locale(decimal_mark = ",", grouping_mark = "."), 
    trim_ws = TRUE, skip = 21,
    col_select = c("Time", "Signal"))
...
df4yjeQCam <- read_delim("Data5/measurements_21-12-24_11-07-41.lvm", 
    delim = "\t", escape_double = FALSE, 
    locale = locale(decimal_mark = ",", grouping_mark = "."), 
    trim_ws = TRUE, skip = 21,
    col_select = c("Time", "Signal"))
...
df4rbfA <- read_delim("Data5/measurements_21-12-24_10-54-53.lvm", 
    delim = "\t", escape_double = FALSE, 
    locale = locale(decimal_mark = ",", grouping_mark = "."), 
    trim_ws = TRUE, skip = 21,
    col_select = c("Time", "Signal"))
...
df4rbfACam <- read_delim("Data5/measurements_21-12-24_11-13-45.lvm", 
    delim = "\t", escape_double = FALSE, 
    locale = locale(decimal_mark = ",", grouping_mark = "."), 
    trim_ws = TRUE, skip = 21,
    col_select = c("Time", "Signal"))
...
```{r}
 rbind(df4rbfA,df4rbfACam) %>% ggplot()+
    geom_line(aes(Time,Signal),size=1.5)+
  facet_wrap(~Sample)+
  labs(y="AU260", 
       x="Time (second)", 
...
```{r}
ggsave("A1_rbfA deletion gradient.pdf", width = 6, height = 5)
```
...
```{r}
ggsave("A2_yjeQ deletion gradient.pdf", width = 6, height = 5)
```
...
```
```{r}
ggsave("A3_WT Keio gradient.pdf", width = 6, height = 5)
```

```{r}
df5WT <- read_delim("Data6/measurements_21-12-30_10-32-53.lvm", 
    delim = "\t", escape_double = FALSE, 
    locale = locale(decimal_mark = ",", grouping_mark = "."), 
    trim_ws = TRUE, skip = 21,
    col_select = c("Time", "Signal"))
...
df5WTCam <- read_delim("Data6/measurements_21-12-30_10-39-29.lvm", 
    delim = "\t", escape_double = FALSE, 
    locale = locale(decimal_mark = ",", grouping_mark = "."), 
    trim_ws = TRUE, skip = 21,
    col_select = c("Time", "Signal"))
...
df5WTeryth <- read_delim("Data6/measurements_21-12-30_10-45-15.lvm", 
    delim = "\t", escape_double = FALSE, 
    locale = locale(decimal_mark = ",", grouping_mark = "."), 
    trim_ws = TRUE, skip = 21,
    col_select = c("Time", "Signal"))
...
df5ybeY <- read_delim("Data6/measurements_21-12-30_10-52-03.lvm", 
    delim = "\t", escape_double = FALSE, 
    locale = locale(decimal_mark = ",", grouping_mark = "."), 
    trim_ws = TRUE, skip = 21,
    col_select = c("Time", "Signal"))
...
df5ybeYCam <- read_delim("Data6/measurements_21-12-30_10-58-01.lvm", 
    delim = "\t", escape_double = FALSE, 
    locale = locale(decimal_mark = ",", grouping_mark = "."), 
    trim_ws = TRUE, skip = 21,
    col_select = c("Time", "Signal"))
...
df5ybeYeryth <- read_delim("Data6/measurements_21-12-30_11-03-59.lvm", 
    delim = "\t", escape_double = FALSE, 
    locale = locale(decimal_mark = ",", grouping_mark = "."), 
    trim_ws = TRUE, skip = 21,
    col_select = c("Time", "Signal"))
...
```
```{r}
ggsave("B1_WT Keio gradient.pdf", width = 6, height = 5)
```
...
```{r}
ggsave("B2_ybeY deletion gradient.pdf", width = 6, height = 5)
```
