...
```{r}
WT1 <- read_delim("Measurements/Data0/measurements_21-11-30_08-52-11 WT Keio OD600 0_5.lvm", 
    delim = "\t", escape_double = FALSE, 
    locale = locale(decimal_mark = ",", grouping_mark = "."), 
    trim_ws = TRUE, skip = 21,
    col_select = c("Time", "Signal"))
WT1 <- mutate(WT1, Strain="WT Keio", Sample = "exp1", Date="2021-11-30")

```

```{r}

a <- WT37 %>% select(-c(Strain, Sample, Date))
write.csv(a, "dataWT37.csv", row.names = FALSE)

b <- WT40 %>% select(-c(Strain, Sample, Date))
write.csv(b, "dataWT40.csv", row.names = FALSE)

c <- ybeX37 %>% select(-c(Strain, Sample, Date))
write.csv(c, "dataybeX37.csv", row.names = FALSE)

d <- ybeX40 %>% select(-c(Strain, Sample, Date))
write.csv(d, "dataybeX40.csv", row.names = FALSE)

e <- ybeY37 %>% select(-c(Strain, Sample, Date))
write.csv(e, "dataybeY37.csv", row.names = FALSE)

f <- ybeY40 %>% select(-c(Strain, Sample, Date))
write.csv(f, "dataybeY40.csv", row.names = FALSE)

```


andmed=read.table('Margus code/signals1.txt', header=TRUE, sep="\t",dec=",")
```{r}
andism=read.csv("dataybeY40.csv")
andmed=andism
attach(andmed)
...
for(j in 1:1000){
  ...
  integral2[j]=0
  integral3[j]=0
  time1=60+runif(1,-5,5)
  time2=105+runif(1,-5,5)
  time3=160+runif(1,-5,5)
  time4=205+runif(1,-5.5)
...
```{r}
WT2 <- read_delim("Measurements/Data0/measurements_21-11-30_08-59-00 WT Keio OD600 0_5 plus 1hour.lvm", 
    delim = "\t", escape_double = FALSE, 
    locale = locale(decimal_mark = ",", grouping_mark = "."), 
    trim_ws = TRUE, skip = 21,
    col_select = c("Time", "Signal"))
WT2 <- mutate(WT2, Strain="WT Keio", Sample = "exp2", Date="2021-11-30")
```

```{r}
WT3 <- read_delim("Measurements/Data0/measurements_21-11-30_09-04-59 WT Keio OD600 0_5 plus 2hours.lvm", 
    delim = "\t", escape_double = FALSE, 
    locale = locale(decimal_mark = ",", grouping_mark = "."), 
    trim_ws = TRUE, skip = 21,
    col_select = c("Time", "Signal"))
WT3 <- mutate(WT3, Strain="WT Keio", Sample = "stat1", Date="2021-11-30")
```

```{r}
ybeX1 <- read_delim("Measurements/Data0/measurements_21-11-30_09-12-12 ybeX OD600 0_5.lvm",
    delim = "\t", escape_double = FALSE, 
    locale = locale(decimal_mark = ",", grouping_mark = "."), 
    trim_ws = TRUE, skip = 21,
    col_select = c("Time", "Signal"))
ybeX1 <- mutate(ybeX1, Strain="ybeX", Sample = "exp1", Date="2021-11-30")
```

```{r}
ybeX2 <- read_delim("Measurements/Data0/measurements_21-11-30_09-18-33 ybeX OD600 0_5 plus 1hour.lvm",
    delim = "\t", escape_double = FALSE, 
    locale = locale(decimal_mark = ",", grouping_mark = "."), 
    trim_ws = TRUE, skip = 21,
    col_select = c("Time", "Signal"))
ybeX2 <- mutate(ybeX2, Strain="ybeX", Sample = "exp2", Date="2021-11-30")
```
```{r}
ybeX3 <- read_delim("Measurements/Data0/measurements_21-11-30_09-24-57 ybeX OD600 0_5 plus 2hours.lvm",
    delim = "\t", escape_double = FALSE, 
    locale = locale(decimal_mark = ",", grouping_mark = "."), 
    trim_ws = TRUE, skip = 21,
    col_select = c("Time", "Signal"))
ybeX3 <- mutate(ybeX3, Strain="ybeX", Sample = "stat1", Date="2021-11-30")
```
...
```{r}
ggsave(file = "PDFiles/WT ybeX gradients.pdf")
```
...
```{r}
ggsave(file = "PDFiles/WT ybeX gradients quant.pdf", width = 5, height = 4)
```


```{r}
WT37 <- read_delim("Measurements/Data1/measurements_21-12-03_11-34-21 WT Keio 37C after OD600 0.55 2hour.lvm", 
    delim = "\t", escape_double = FALSE, 
    locale = locale(decimal_mark = ",", grouping_mark = "."), 
    trim_ws = TRUE, skip = 21,
    col_select = c("Time", "Signal"))
...
```{r}
WT40 <- read_delim("Measurements/Data1/measurements_21-12-03_11-42-09 WT Keio 40C after OD600 0.55 2hour.lvm", 
    delim = "\t", escape_double = FALSE, 
    locale = locale(decimal_mark = ",", grouping_mark = "."), 
    trim_ws = TRUE, skip = 21,
    col_select = c("Time", "Signal"))
...
```{r}
ybeX37 <- read_delim("Measurements/Data1/measurements_21-12-03_11-48-42 ybeX 37C after OD600 0.55 2hour.lvm", 
    delim = "\t", escape_double = FALSE, 
    locale = locale(decimal_mark = ",", grouping_mark = "."), 
    trim_ws = TRUE, skip = 21,
    col_select = c("Time", "Signal"))
...
```{r}
ybeX40 <- read_delim("Measurements/Data1/measurements_21-12-03_11-58-06 ybeX 40C after OD600 0.55 2hour.lvm", 
    delim = "\t", escape_double = FALSE, 
    locale = locale(decimal_mark = ",", grouping_mark = "."), 
    trim_ws = TRUE, skip = 21,
    col_select = c("Time", "Signal"))
...
```{r}
ybeY37 <- read_delim("Measurements/Data1/measurements_21-12-03_12-07-12 ybeY 37C after OD600 0.55 1hour.lvm", 
    delim = "\t", escape_double = FALSE, 
    locale = locale(decimal_mark = ",", grouping_mark = "."), 
    trim_ws = TRUE, skip = 21,
    col_select = c("Time", "Signal"))
...
```{r}
ybeY40 <- read_delim("Measurements/Data1/measurements_21-12-03_12-16-32 ybeY 40C after OD600 0.55 1hour.lvm", 
    delim = "\t", escape_double = FALSE, 
    locale = locale(decimal_mark = ",", grouping_mark = "."), 
    trim_ws = TRUE, skip = 21,
    col_select = c("Time", "Signal"))
...
write.table(WT37, file = "WT37.txt", sep = "\t",
            row.names = FALSE)
write.table(WT40, file = "WT40.txt", sep = "\t",
            row.names = FALSE)
write.table(ybeX37, file = "ybeX37.txt", sep = "\t",
            row.names = FALSE)
write.table(ybeX40, file = "ybeX40.txt", sep = "\t",
            row.names = FALSE)
write.table(ybeY37, file = "ybeY37.txt", sep = "\t",
            row.names = FALSE)
write.table(ybeY40, file = "ybeY40.txt", sep = "\t",
            row.names = FALSE)
...
```{r}
WTv37 <- read_delim("Measurements/Data1/measurements_21-12-04_09-25-32 WT Keio 37C after OD600 0.55 2hour.lvm", 
    delim = "\t", escape_double = FALSE, 
    locale = locale(decimal_mark = ",", grouping_mark = "."), 
    trim_ws = TRUE, skip = 21,
    col_select = c("Time", "Signal"))
...
```{r}
WTv40 <- read_delim("Measurements/Data1/measurements_21-12-04_09-32-41 WT Keio 40C after OD600 0.55 2hour.lvm", 
    delim = "\t", escape_double = FALSE, 
    locale = locale(decimal_mark = ",", grouping_mark = "."), 
    trim_ws = TRUE, skip = 21,
    col_select = c("Time", "Signal"))
...
```{r}
ybeXv37 <- read_delim("Measurements/Data1/measurements_21-12-04_09-39-02 ybeX 37C after OD600 0.55 2hour.lvm", 
    delim = "\t", escape_double = FALSE, 
    locale = locale(decimal_mark = ",", grouping_mark = "."), 
    trim_ws = TRUE, skip = 21,
    col_select = c("Time", "Signal"))
...
```{r}
ybeXv40 <- read_delim("Measurements/Data1/measurements_21-12-04_09-47-56 ybeX 40C after OD600 0.55 2hour.lvm", 
    delim = "\t", escape_double = FALSE, 
    locale = locale(decimal_mark = ",", grouping_mark = "."), 
    trim_ws = TRUE, skip = 21,
    col_select = c("Time", "Signal"))
...
```{r}
ybeYv37 <- read_delim("Measurements/Data1/measurements_21-12-04_09-57-43 ybeY 37C after OD600 0.55 1hour.lvm", 
    delim = "\t", escape_double = FALSE, 
    locale = locale(decimal_mark = ",", grouping_mark = "."), 
    trim_ws = TRUE, skip = 21,
    col_select = c("Time", "Signal"))
...
```{r}
ybeYv40 <- read_delim("Measurements/Data1/measurements_21-12-04_10-06-29 ybeY 40C after OD600 0.55 1hour.lvm", 
    delim = "\t", escape_double = FALSE, 
    locale = locale(decimal_mark = ",", grouping_mark = "."), 
    trim_ws = TRUE, skip = 21,
    col_select = c("Time", "Signal"))
...
ggplot(data=tempgradbindall)+
  ...
  labs(x="Time(second)", y="AU260")+
  theme_bw()
```

```{r}
ggsave(file = "TIFFile/sWT ybeY ybeX sucgrad 37C-40C.tiff", width = 6, height = 4)
```
...
```{r}
ggsave(file = "PDFiles/WT ybeX gradients37_40.pdf")
```

```{r}
df1WT37 <- read_delim("Measurements/Data2/measurements_21-12-16_09-13-57.lvm", 
    delim = "\t", escape_double = FALSE, 
    locale = locale(decimal_mark = ",", grouping_mark = "."), 
    trim_ws = TRUE, skip = 21,
    col_select = c("Time", "Signal"))
...
```
```{r}
df1WT43 <- read_delim("Measurements/Data2/measurements_21-12-16_09-19-52.lvm", 
    delim = "\t", escape_double = FALSE, 
    locale = locale(decimal_mark = ",", grouping_mark = "."), 
    trim_ws = TRUE, skip = 21,
    col_select = c("Time", "Signal"))
...
```
```{r}
df1ybeX37 <- read_delim("Measurements/Data2/measurements_21-12-16_09-25-34.lvm", 
    delim = "\t", escape_double = FALSE, 
    locale = locale(decimal_mark = ",", grouping_mark = "."), 
    trim_ws = TRUE, skip = 21,
    col_select = c("Time", "Signal"))
...
```
```{r}
df1ybeX43 <- read_delim("Measurements/Data2/measurements_21-12-16_09-31-24.lvm", 
    delim = "\t", escape_double = FALSE, 
    locale = locale(decimal_mark = ",", grouping_mark = "."), 
    trim_ws = TRUE, skip = 21,
    col_select = c("Time", "Signal"))
...
```{r}
df1ybeY37 <- read_delim("Measurements/Data2/measurements_21-12-16_09-38-53.lvm", 
    delim = "\t", escape_double = FALSE, 
    locale = locale(decimal_mark = ",", grouping_mark = "."), 
    trim_ws = TRUE, skip = 21,
    col_select = c("Time", "Signal"))
...
```
```{r}
df1ybeY43 <- read_delim("Measurements/Data2/measurements_21-12-16_09-45-05.lvm", 
    delim = "\t", escape_double = FALSE, 
    locale = locale(decimal_mark = ",", grouping_mark = "."), 
    trim_ws = TRUE, skip = 21,
    col_select = c("Time", "Signal"))
...
```{r}
df1rbind %>% ggplot()+
    geom_line(aes(Time,Signal, color=Sample), size=1)+
...
```
```{r}
df2WT37 <- read_delim("Measurements/Data3/measurements_21-12-22_09-50-34.lvm", 
    delim = "\t", escape_double = FALSE, 
    locale = locale(decimal_mark = ",", grouping_mark = "."), 
    trim_ws = TRUE, skip = 21,
    col_select = c("Time", "Signal"))
...
```
```{r}
df2WT43 <- read_delim("Measurements/Data3/measurements_21-12-22_09-56-24.lvm", 
    delim = "\t", escape_double = FALSE, 
    locale = locale(decimal_mark = ",", grouping_mark = "."), 
    trim_ws = TRUE, skip = 21,
    col_select = c("Time", "Signal"))
...
```
```{r}
df2ybeX37 <- read_delim("Measurements/Data3/measurements_21-12-22_10-02-27.lvm", 
    delim = "\t", escape_double = FALSE, 
    locale = locale(decimal_mark = ",", grouping_mark = "."), 
    trim_ws = TRUE, skip = 21,
    col_select = c("Time", "Signal"))
...
```
```{r}
df2ybeX43 <- read_delim("Measurements/Data3/measurements_21-12-22_10-08-03.lvm", 
    delim = "\t", escape_double = FALSE, 
    locale = locale(decimal_mark = ",", grouping_mark = "."), 
    trim_ws = TRUE, skip = 21,
    col_select = c("Time", "Signal"))
...
```
```{r}
df2ybeY37 <- read_delim("Measurements/Data3/measurements_21-12-22_10-15-20.lvm", 
    delim = "\t", escape_double = FALSE, 
    locale = locale(decimal_mark = ",", grouping_mark = "."), 
    trim_ws = TRUE, skip = 21,
    col_select = c("Time", "Signal"))
...
```
```{r}
df2ybeY43 <- read_delim("Measurements/Data3/measurements_21-12-22_10-21-26.lvm", 
    delim = "\t", escape_double = FALSE, 
    locale = locale(decimal_mark = ",", grouping_mark = "."), 
    trim_ws = TRUE, skip = 21,
    col_select = c("Time", "Signal"))
...
```{r}
 rbind(df2rbind, df1rbind) %>% ggplot()+
    geom_line(aes(Time,Signal, color=Strain))+
    facet_grid(Date~Sample)+
  theme_bw()
```
```{r}
ggsave("TIFFiles/WT ybeY ybeX sucgrad 37C-43C.tiff", width = 6, height = 5)
```


```{r}
df3WT <- read_delim("Measurements/Data4/measurements_18-06-02_11-11-54 WT Keio 2hours after OD600 0_3.lvm", 
    delim = "\t", escape_double = FALSE, 
    locale = locale(decimal_mark = ",", grouping_mark = "."), 
    trim_ws = TRUE, skip = 21,
    col_select = c("Time", "Signal"))
df3WT <- mutate(df3WT, Strain="WT", 
                  Sample = "37C",Date="2018-06-02")
```

```{r}
df3WTCAM <- read_delim("Measurements/Data4/measurements_18-06-02_11-18-46 WT Keio CAM 2hours.lvm", 
    delim = "\t", escape_double = FALSE, 
    locale = locale(decimal_mark = ",", grouping_mark = "."), 
    trim_ws = TRUE, skip = 21,
    col_select = c("Time", "Signal"))
df3WTCAM <- mutate(df3WTCAM, Strain="WT", 
                  Sample = "CAM",Date="2018-06-02")
```
```{r}
df3yjeQ <- read_delim("Measurements/Data4/measurements_18-06-02_11-37-30 yjeQ 2hour plus OD600 0_3.lvm", 
    delim = "\t", escape_double = FALSE, 
    locale = locale(decimal_mark = ",", grouping_mark = "."), 
    trim_ws = TRUE, skip = 21,
    col_select = c("Time", "Signal"))
df3yjeQ <- mutate(df3yjeQ, Strain="yjeQ", 
                  Sample = "37C",Date="2018-06-02")
```

```{r}
df3yjeQCAM <- read_delim("Measurements/Data4/measurements_18-06-02_11-43-11 yjeQ CAM 2hour.lvm", 
    delim = "\t", escape_double = FALSE, 
    locale = locale(decimal_mark = ",", grouping_mark = "."), 
    trim_ws = TRUE, skip = 21,
    col_select = c("Time", "Signal"))
df3yjeQCAM <- mutate(df3yjeQCAM, Strain="yjeQ", 
                  Sample = "CAM",Date="2018-06-02")
```

```{r}
bindall <- rbind(WT37, WT40, WTv37, WTv40, ybeX37, ybeX40, ybeXv37, ybeXv40, df1WT37,df1WT43,df1ybeX37,df1ybeX43,df1ybeY37,df1ybeY43,df2WT37,df2WT43,df2ybeX37,df2ybeX43,df2ybeY37,df2ybeY43)
```


```{r}
df4WT <- read_delim("Measurements/Data5/measurements_21-12-24_10-42-56.lvm", 
    delim = "\t", escape_double = FALSE, 
    locale = locale(decimal_mark = ",", grouping_mark = "."), 
    trim_ws = TRUE, skip = 21,
    col_select = c("Time", "Signal"))
df4WT <- mutate(df4WT, Strain="WT", 
                  Sample = "2hourplus",Date="2021-12-24")

df4WTCam <- read_delim("Measurements/Data5/measurements_21-12-24_11-01-58.lvm", 
    delim = "\t", escape_double = FALSE, 
    locale = locale(decimal_mark = ",", grouping_mark = "."), 
    trim_ws = TRUE, skip = 21,
    col_select = c("Time", "Signal"))
df4WTCam <- mutate(df4WTCam, Strain="WT", 
                  Sample = "CAM",Date="2021-12-24")

df4yjeQ <- read_delim("Measurements/Data5/measurements_21-12-24_10-48-46.lvm", 
    delim = "\t", escape_double = FALSE, 
    locale = locale(decimal_mark = ",", grouping_mark = "."), 
    trim_ws = TRUE, skip = 21,
    col_select = c("Time", "Signal"))
df4yjeQ <- mutate(df4yjeQ, Strain="yjeQ", 
                  Sample = "2hourplus",Date="2021-12-24")

df4yjeQCam <- read_delim("Measurements/Data5/measurements_21-12-24_11-07-41.lvm", 
    delim = "\t", escape_double = FALSE, 
    locale = locale(decimal_mark = ",", grouping_mark = "."), 
    trim_ws = TRUE, skip = 21,
    col_select = c("Time", "Signal"))
df4yjeQCam <- mutate(df4yjeQCam, Strain="yjeQ", 
                  Sample = "CAM",Date="2021-12-24")

df4rbfA <- read_delim("Measurements/Data5/measurements_21-12-24_10-54-53.lvm", 
    delim = "\t", escape_double = FALSE, 
    locale = locale(decimal_mark = ",", grouping_mark = "."), 
    trim_ws = TRUE, skip = 21,
    col_select = c("Time", "Signal"))
df4rbfA <- mutate(df4rbfA, Strain="rbfA", 
                  Sample = "2hourplus",Date="2021-12-24")

df4rbfACam <- read_delim("Measurements/Data5/measurements_21-12-24_11-13-45.lvm", 
    delim = "\t", escape_double = FALSE, 
    locale = locale(decimal_mark = ",", grouping_mark = "."), 
    trim_ws = TRUE, skip = 21,
    col_select = c("Time", "Signal"))
df4rbfACam <- mutate(df4rbfACam, Strain="rbfA", 
                  Sample = "CAM",Date="2021-12-24")
...
df4WT,df4WTCam,
```{r}
 rbind(df4yjeQ,df4yjeQCam) %>% ggplot()+
    geom_line(aes(Time,Signal, color=Sample), size=1.5)+
    facet_wrap(~Sample, scales = "free_y",)+
  labs(y="AU260", x="Time(Second)")+
  theme_cowplot()
```

```{r}
 rbind(df4rbfA,df4rbfACam) %>% ggplot()+
    geom_line(aes(Time,Signal, color=Sample),size=1.5)+
  #facet_wrap(~Sample)+
  labs(y="AU260", 
       x="Time (second)", 
       title="Sucrose Gradients of RbfA Deletion strain") +
   theme_bw()
```

```{r}
ggsave("PDFiles/A1_rbfA deletion gradient.pdf", width = 6, height = 5)
```
...
```{r}
 rbind(df4yjeQ,df4yjeQCam) %>% ggplot()+
  ...
  labs(y="AU260", 
       x="Time (second)", 
       title="Sucrose Gradients of yjeQ Deletion strain") +
   theme_bw()
```

```{r}
ggsave("PDFiles/A2_yjeQ deletion gradient.pdf", width = 6, height = 5)
```

```{r}
 rbind(df4WT,df4WTCam) %>% ggplot()+
    geom_line(aes(Time,Signal, color=Sample),size=1.5)+
  facet_wrap(~Sample)+
  labs(y="AU260", 
       x="Time (second)", 
       title="Sucrose Gradients of WT Keio strain") +
   theme_bw()
```
```{r}
ggsave("PDFiles/A3_WT Keio gradient.pdf", width = 6, height = 5)
```

```{r}
df5WT <- read_delim("Measurements/Data6/measurements_21-12-30_10-32-53.lvm", 
    delim = "\t", escape_double = FALSE, 
    locale = locale(decimal_mark = ",", grouping_mark = "."), 
    trim_ws = TRUE, skip = 21,
    col_select = c("Time", "Signal"))
df5WT <- mutate(df5WT, Strain="WT", 
                  Sample = "2hourplus",Date="2021-12-30")

df5WTCam <- read_delim("Measurements/Data6/measurements_21-12-30_10-39-29.lvm", 
    delim = "\t", escape_double = FALSE, 
    locale = locale(decimal_mark = ",", grouping_mark = "."), 
    trim_ws = TRUE, skip = 21,
    col_select = c("Time", "Signal"))
df5WTCam <- mutate(df5WTCam, Strain="WT", 
                  Sample = "CAM",Date="2021-12-30")

df5WTeryth <- read_delim("Measurements/Data6/measurements_21-12-30_10-45-15.lvm", 
    delim = "\t", escape_double = FALSE, 
    locale = locale(decimal_mark = ",", grouping_mark = "."), 
    trim_ws = TRUE, skip = 21,
    col_select = c("Time", "Signal"))
df5WTeryth <- mutate(df5WTeryth, Strain="WT", 
                  Sample = "ERYTH",Date="2021-12-30")

df5ybeY <- read_delim("Measurements/Data6/measurements_21-12-30_10-52-03.lvm", 
    delim = "\t", escape_double = FALSE, 
    locale = locale(decimal_mark = ",", grouping_mark = "."), 
    trim_ws = TRUE, skip = 21,
    col_select = c("Time", "Signal"))
df5ybeY <- mutate(df5ybeY, Strain="ybeY", 
                  Sample = "2hourplus",Date="2021-12-30")

df5ybeYCam <- read_delim("Measurements/Data6/measurements_21-12-30_10-58-01.lvm", 
    delim = "\t", escape_double = FALSE, 
    locale = locale(decimal_mark = ",", grouping_mark = "."), 
    trim_ws = TRUE, skip = 21,
    col_select = c("Time", "Signal"))
df5ybeYCam <- mutate(df5ybeYCam, Strain="ybeY", 
                  Sample = "CAM",Date="2021-12-30")

df5ybeYeryth <- read_delim("Measurements/Data6/measurements_21-12-30_11-03-59.lvm", 
    delim = "\t", escape_double = FALSE, 
    locale = locale(decimal_mark = ",", grouping_mark = "."), 
    trim_ws = TRUE, skip = 21,
    col_select = c("Time", "Signal"))
df5ybeYeryth <- mutate(df5ybeYeryth, Strain="ybeY", 
                  Sample = "ERYTH",Date="2021-12-30")

```

```{r}
 rbind(df5WT,df5WTCam,df5WTeryth) %>% ggplot()+
    geom_line(aes(Time,Signal, color=Sample),size=1.5)+
  #facet_wrap(~Sample)+
  labs(y="AU260", 
       x="Time (second)", 
...
```
```{r}
ggsave("TIFFiles/B1_WT Keio gradient.tiff", width = 6, height = 5)
```


```{r}
 rbind(df5ybeY,df5ybeYCam,df5ybeYeryth) %>% ggplot()+
    geom_line(aes(Time,Signal, color=Sample),size=1.5)+
  #facet_wrap(~Sample, scales="free_y")+
  labs(y="AU260", 
       x="Time(second)", 
       title="Sucrose Gradients of ybeY deletion strain") +
   theme_bw()
```

```{r}
ggsave("TIFFiles/B2_ybeY deletion gradient.tiff", width =9, height = 5)
```



```{r}
ggplot(data=df4rbfACam)+
  geom_line(aes(Time,Signal))+
  geom_vline(xintercept = c(25,80,135,200))

```
```{r}
##70S/50S for df4rbfA     25,80,135,200
AUC(df4rbfA$Time, df4rbfA$Signal, from = min(25, na.rm = TRUE), to = max(80, na.rm = TRUE), method = c("trapezoid")) / AUC(df4rbfA$Time, df4rbfA$Signal, from = min(80, na.rm = TRUE), to = max(135, na.rm = TRUE), method = c("trapezoid"))

##70S/30S for df4rbfA 
AUC(df4rbfA$Time, df4rbfA$Signal, from = min(25, na.rm = TRUE), to = max(80, na.rm = TRUE), method = c("trapezoid")) / AUC(df4rbfA$Time, df4rbfA$Signal, from = min(135, na.rm = TRUE), to = max(200, na.rm = TRUE), method = c("trapezoid"))

AUC(df4rbfA$Time, df4rbfA$Signal, from = min(25, na.rm = TRUE), to = max(80, na.rm = TRUE), method = c("trapezoid"))
AUC(df4rbfA$Time, df4rbfA$Signal, from = min(80, na.rm = TRUE), to = max(135, na.rm = TRUE), method = c("trapezoid"))
AUC(df4rbfA$Time, df4rbfA$Signal, from = min(135, na.rm = TRUE), to = max(200, na.rm = TRUE), method = c("trapezoid"))
```

```{r}
bindall$Strain <- str_replace_all(bindall$Strain, " Keio", "")
write.csv(bindall,"Sucrose Grad 37C-40C-43C.csv")

```


```{r}
rbind(df4WT,df4WTCam,df4rbfA,df4rbfACam) %>% mutate(fct_relevel(Sample,"2hourplus","CAM")) %>%  ggplot(aes(Time, Signal)) + geom_line(size=1.5) + facet_wrap(Strain~Sample, scales="free_y")+
  ggthemes::theme_tufte()+
    scale_x_continuous(breaks = NULL)+
  scale_y_continuous(breaks = NULL)+
  xlab(NULL)+ ylab(NULL)+
  theme(axis.title = element_text(size = 16, face = "bold"))
ggsave("lastplot.tiff", plot = last_plot(), height = 6, width = 4, dpi = 750)
```


```{r}
library(latticeExtra)
rbfA <- xyplot(Signal ~ Time, df4rbfA, type = "l" , lwd=2, col="steelblue")
rbfACam <- xyplot(Signal ~ Time, df4rbfACam, type = "l", lwd=2, col="#69b3a2")
doubleYScale(rbfA, rbfACam, add.ylab2 = TRUE, use.style=FALSE )
```

```{r}
df4WT %>% mutate(Signal=Signal*2.2) %>%  rbind(df4WTCam,df4rbfA,df4rbfACam) %>%  ggplot(aes(Time, Signal, linetype=Sample, color=Sample)) + geom_line(aes(alpha=Sample), size=1.5) + facet_wrap(~Strain, scales="free_y")+
  ggthemes::theme_tufte()+
  scale_alpha_manual(values =c(0.8,1))+
  scale_linetype_manual(values = c("twodash", "solid"))+
  scale_color_manual(values = c("gray0", "black"))+
    scale_x_continuous(breaks = NULL)+
  scale_y_continuous(breaks = NULL)+
  xlab(NULL)+ ylab(NULL)+
  theme(axis.title = element_text(size = 16, face = "bold"))
ggsave("lastplot.tiff", plot = last_plot(), height = 4, width = 6, dpi = 750)
```

```{r}
df5ybeY %>% mutate(Signal=Signal*2.2) %>% rbind(df4yjeQ,df4yjeQCam,df5ybeYCam) %>%  ggplot(aes(Time, Signal, linetype=Sample, color=Sample)) + geom_line(aes(alpha=Sample), size=1.5) + facet_wrap(~Strain, scales="free_y")+
  ggthemes::theme_tufte()+
  scale_alpha_manual(values =c(0.8,1))+
  scale_linetype_manual(values = c("twodash", "solid"))+
  scale_color_manual(values = c("gray0", "black"))+
